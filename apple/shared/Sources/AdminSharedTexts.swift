...
public enum AdminSharedTexts {
    private static let texts: [String: [String: String]] = [
        "en": [
            ...
            "already_recreated_as": "Already recreated as order",
            "answer": "Answer",
            ...
            "confirm_recreated_order": "Confirm recreated order",
            ...
            "group_type_delivery_pending_addition": "Pending delivery addition",
            "group_type_initial_checkout": "Initial checkout",
            "group_type_pickup_waiting_ready_confirmation": "Pickup awaiting readiness confirmation",
            "group_type_recreated_order": "Recreated order",
            "group_type_scheduled_next_online_order_delivery": "Scheduled for next online delivery order",
            "group_type_scheduled_next_online_order_pickup": "Scheduled for next online pickup order",
            ...
            "recreate_another_order": "Recreate another order",
            "recreate_another_order_warning": "Previous recreations are terminal. This creates another independent order.",
            "recreate_order": "Recreate order",
            "recreated_from_order": "Recreated from order",
            "recreation_awaiting_confirmation": "Awaiting admin review and confirmation.",
            "recreation_failed": "Order recreation failed",
            "recreation_reason": "Reason for recreating the order",
            "refresh": "Refresh",
            "reject": "Reject",
        ...
        "de": [
            ...
            "already_recreated_as": "Bereits neu erstellt als Bestellung",
            "answer": "Antworten",
            ...
            "confirm_recreated_order": "Neu erstellte Bestellung bestätigen",
            ...
            "group_type_delivery_pending_addition": "Ausstehende Lieferergänzung",
            "group_type_initial_checkout": "Erster Checkout",
            "group_type_pickup_waiting_ready_confirmation": "Abholung wartet auf Bereitschaftsbestätigung",
            "group_type_recreated_order": "Neu erstellte Bestellung",
            "group_type_scheduled_next_online_order_delivery": "Für die nächste Online-Lieferbestellung eingeplant",
            "group_type_scheduled_next_online_order_pickup": "Für die nächste Online-Abholbestellung eingeplant",
            ...
            "recreate_another_order": "Eine weitere Bestellung neu erstellen",
            "recreate_another_order_warning": "Frühere Neuerstellungen sind abgeschlossen. Dadurch wird eine weitere unabhängige Bestellung erstellt.",
            "recreate_order": "Bestellung neu erstellen",
            "recreated_from_order": "Neu erstellt aus Bestellung",
            "recreation_awaiting_confirmation": "Wartet auf Prüfung und Bestätigung durch den Admin.",
            "recreation_failed": "Bestellung konnte nicht neu erstellt werden",
            "recreation_reason": "Grund für die Neuerstellung",
        ...
        "tr": [
            ...
            "already_recreated_as": "Zaten şu sipariş olarak yeniden oluşturuldu",
            "answer": "Cevapla",
            ...
            "confirm_recreated_order": "Yeniden oluşturulan siparişi onayla",
            ...
            "group_type_delivery_pending_addition": "Bekleyen teslimat eklemesi",
            "group_type_initial_checkout": "İlk checkout",
            "group_type_pickup_waiting_ready_confirmation": "Teslim alma için hazır olma onayı bekleniyor",
            "group_type_recreated_order": "Yeniden oluşturulan sipariş",
            "group_type_scheduled_next_online_order_delivery": "Sonraki çevrimiçi teslimat siparişi için planlandı",
            "group_type_scheduled_next_online_order_pickup": "Sonraki çevrimiçi teslim alma siparişi için planlandı",
            ...
            "recreate_another_order": "Başka bir siparişi yeniden oluştur",
            "recreate_another_order_warning": "Önceki yeniden oluşturulan siparişler sonlandırıldı. Bu işlem bağımsız yeni bir sipariş oluşturur.",
            "recreate_order": "Siparişi yeniden oluştur",
            "recreated_from_order": "Şu siparişten yeniden oluşturuldu",
            "recreation_awaiting_confirmation": "Admin incelemesi ve onayı bekleniyor.",
            "recreation_failed": "Sipariş yeniden oluşturulamadı",
            "recreation_reason": "Siparişi yeniden oluşturma nedeni",
            "refresh": "Yenile",
            "reject": "Reddet",
        ...
        "ar": [
            ...
            "already_recreated_as": "أُعيد إنشاؤه بالفعل كطلب",
            "answer": "رد",
            ...
            "confirm_recreated_order": "تأكيد الطلب المعاد إنشاؤه",
            ...
            "group_type_delivery_pending_addition": "إضافة توصيل معلّقة",
            "group_type_initial_checkout": "الدفع الأولي",
            "group_type_pickup_waiting_ready_confirmation": "الاستلام بانتظار تأكيد الجاهزية",
            "group_type_recreated_order": "طلب مُعاد إنشاؤه",
            "group_type_scheduled_next_online_order_delivery": "مجدول لطلب التوصيل التالي عبر الإنترنت",
            "group_type_scheduled_next_online_order_pickup": "مجدول لطلب الاستلام التالي عبر الإنترنت",
            ...
            "recreate_another_order": "إعادة إنشاء طلب آخر",
            "recreate_another_order_warning": "انتهت الطلبات المعاد إنشاؤها سابقًا. سيؤدي هذا إلى إنشاء طلب مستقل آخر.",
            "recreate_order": "إعادة إنشاء الطلب",
            "recreated_from_order": "أُعيد إنشاؤه من الطلب",
            "recreation_awaiting_confirmation": "بانتظار مراجعة المسؤول وتأكيده.",
            "recreation_failed": "فشلت إعادة إنشاء الطلب",
            "recreation_reason": "سبب إعادة إنشاء الطلب",
            "refresh": "تحديث",
            "reject": "رفض",
        ...
        "ru": [
            ...
            "already_recreated_as": "Уже создан заново как заказ",
            "answer": "Ответить",
            ...
            "confirm_recreated_order": "Подтвердить созданный заново заказ",
            ...
            "group_type_delivery_pending_addition": "Ожидающее добавление к доставке",
            "group_type_initial_checkout": "Первичный checkout",
            "group_type_pickup_waiting_ready_confirmation": "Самовывоз ожидает подтверждения готовности",
            "group_type_recreated_order": "Заказ создан заново",
            "group_type_scheduled_next_online_order_delivery": "Запланировано для следующего онлайн-заказа с доставкой",
            "group_type_scheduled_next_online_order_pickup": "Запланировано для следующего онлайн-заказа с самовывозом",
            ...
            "recreate_another_order": "Создать ещё один заказ заново",
            "recreate_another_order_warning": "Предыдущие созданные заново заказы завершены. Будет создан ещё один независимый заказ.",
            "recreate_order": "Создать заказ заново",
            "recreated_from_order": "Создан заново из заказа",
            "recreation_awaiting_confirmation": "Ожидает проверки и подтверждения администратором.",
            "recreation_failed": "Не удалось создать заказ заново",
            "recreation_reason": "Причина повторного создания заказа",
            "refresh": "Обновить",
            "reject": "Отклонить",
